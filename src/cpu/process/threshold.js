...
const thresholdMoment = function (raster, copy_mode = true){
    ...
    const thresholdMomentFunctionnal = (histogram) => {
    ...
    // Compute threshold
    let the_threshold = thresholdMomentIJ(raster.statistics.histogram);
